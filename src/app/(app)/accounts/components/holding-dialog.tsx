            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <div className="relative" ref={dropdownRef}>
                  <Input
                    placeholder={market === "KR" ? "종목코드 또는 종목명 입력 (예: 005930, 삼성전자)" : "Ticker or name (e.g. AAPL, Apple)"}
                    value={query}
                    onChange={(e) => {
                    ...
                    <div className="absolute z-50 mt-1 w-full rounded-md border bg-background shadow-md max-h-60 overflow-y-auto">
                      {results.map((r) => (
                        ...
                        >
                          ...
                          <span className="shrink-0 text-xs text-muted-foreground">{r.ticker} · {r.exchange}</span>
                        </button>
                      ))}
                    </div>
                  )}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <input
                type="hidden"
                name="avg_price"
                value={avgPriceDisplay.replace(/,/g, "")}
              />
            </div>
          </div>
